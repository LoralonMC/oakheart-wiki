...
Hardened gear is the ultimate equipment tier — **unbreakable** items with maximum enchantments. Upgrade your Reforged gear at **Hammerhand the Smith**.
...
All Hardened items are **Unbreakable** (never lose durability) and have maximum enchantments:
...
| Feature | Benefit |
|---------|---------|
| **Unbreakable** | Never needs repair or Mending |
| **Efficiency VIII** | Instant deepslate mining with Haste II |
| **Protection VIII** | Maximum damage reduction |
| **Fortune/Looting V** | Better drops than vanilla max |
...
- [Smith Overview](overview.md)
- [Reforged Gear](reforged-gear.md)
- [Hardened Ingots](hardened-ingots.md)
