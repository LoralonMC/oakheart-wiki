...
Progress through 20 ranks by voting daily! Each rank unlocks new perks, commands, and rewards.

---

## How Voting Works

1. Use `/vote` to open the voting menu
...
You receive rewards every time you rank up:
