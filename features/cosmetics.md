...
Equippable tags that show next to your name in chat. Pick your active tag from the settings menu.

| Tag | Source |
|-----|--------|
| {{item:devoted_chat_tag}} | Vote Crate (Legendary rarity) |
...
Custom elytra textures from paid crates. One pair per crate tier.
...
Custom messages that display when you join or leave the server. Unlock them from paid crates, then toggle your active message in `/settings`.
...
Placeable decorative items from the Token Trader.
